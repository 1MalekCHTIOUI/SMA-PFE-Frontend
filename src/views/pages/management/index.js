...
import { Grid, Container, Typography, Divider, List,Button,Collapse, ListItem,Alert,AlertTitle, ListItemButton,ListItemText,ListItemIcon} from '@material-ui/core'
...
const Management = () => {
    ...
    return (
        <MainCard title="User management">
            ...
            {deleted && <Alert style={{textAlign: 'center'}} severity="success">
            ...
            <Grid container style={{display:'flex', flexDirection:'column',justifyContent:'center', alignItems:'center', marginBottom:'5rem'}}>
            <Collapse orientation="vertical" in={usersToDelete.length > 0}>
                <List
                    ...
                    >
                        ...
                        <Button variant='contained' color='error' style={{marginLeft: '0.4rem'}} onClick={()=>setShow(true)}>Delete selected users</Button>
                    </List>
                </Collapse>
                <Usertable usersLoading={usersLoading} setUsersToDelete={setUsersToDelete} data={users} setIsEdited={setIsEdited} setIsDeleted={setIsDeleted}/>
            </Grid>
        </MainCard>
    )
}
