...
const ModalC = ({
    ...
    return (
        <>
            {card()}
            <Modal open={openMenu} onClose={handleClose} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
                <Box sx={style}>
                    {type === 'create' && (
                        <>
                    ...
                    <Container className={classes.center}>
                        ...
                        {status === 1 && type === 'remove' && (
                            <Typography className={classes.center}>
                                <Check /> User(s) removed
                            </Typography>
                        )}
                        {status === 1 && type === 'create' && (
                            <Typography className={classes.center}>
                                <Check /> Room created!
                            </Typography>
                        )}
                    ...
                    <Container className={classes.spaceBetween}>
                        {type === 'create' && (
                            <Button variant="contained" color="primary" onClick={submitCreateGroup}>
                                Create group
                            </Button>
                        )}
                        {type === 'add' && (
                            <Button
                                ...
                                color="primary"
                                onClick={() => {
                                    submitAddMember(currentChat, addedMembers);
                                    setStatus(1);
                                }}
                            >
                                Add member(s)
                        ...
                        {type === 'remove' && (
                            <Button
                                ...
                                color="error"
                                onClick={() => {
                                    submitRemoveMember(currentChat, addedMembers);
                                    setStatus(1);
                                }}
                            >
                                remove member(s)
